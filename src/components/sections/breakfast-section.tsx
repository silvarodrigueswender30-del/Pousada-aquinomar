  ...
  return (
    <section id="cafe-da-manha" className="w-full scroll-mt-24 bg-white py-16 md:py-24">
      <div className="mx-auto w-full px-7 md:px-10">
        <div className="grid gap-6 border-y border-brand-primary/10 py-10 md:grid-cols-[22.5%_1fr] md:py-14">
          <div className="flex items-start gap-2">
            <Sparkles className="mt-0.5 h-4 w-4 text-brand-gold" aria-hidden="true" />
          ...
          <div className="max-w-4xl">
            ...
            <p className="mt-6 max-w-2xl text-base font-medium leading-7 text-brand-text md:text-lg">
      ...
      <div className="mx-auto w-full px-7 md:px-10">
        <div className="-mx-4 grid border-b border-brand-primary/10 md:grid-cols-3">
          {breakfastItems.map((item) => (
            <article
              key={item.title}
              className="border-t border-brand-primary/10 px-4 py-8 md:border-r md:border-brand-primary/10 md:p-10 md:last:border-r-0"
            >
              <div className="mb-4 flex items-start justify-between gap-4">
                <h3 className="font-heading text-xl font-semibold leading-none text-brand-primary">
                  {item.title}
                </h3>
                <p className="max-w-[9rem] text-right text-sm font-medium leading-tight text-brand-text/70">
                  {item.meta}
                </p>
              </div>

              <div className="aspect-[400/437] w-full overflow-hidden bg-brand-surface">
