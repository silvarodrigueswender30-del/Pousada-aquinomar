      ...
      <AnimatePresence>
        {isBalloonOpen && (
          <motion.div
            ...
            className="absolute bottom-full mb-4 right-0 bg-white border border-brand-gold/20 shadow-xl rounded-2xl p-4 w-[260px] origin-bottom-right"
          >
            <button
              onClick={closeBalloon}
              className="absolute top-2 right-2 text-brand-text hover:text-brand-primary p-1.5 transition-colors focus:outline-none"
            ...
            <div className="flex gap-3 pr-4">
              ...
              <p className="font-sans text-[15px] leading-snug text-brand-primary">
                {MESSAGE}
              </p>
            </div>
          </motion.div>
